...
const PLAN_META: Record<string, {
  ...
  starter: {
    ...
    interviews: '120 transcribed sessions',
    highlight: false,
    features: [
      '120 session transcriptions / month',
      'Unlimited active job listings',
      'AI transcription & meeting summaries',
      'Standard integrity & focus telemetry',
  ...
  professional: {
    ...
    interviews: '200 transcribed sessions',
    highlight: true,
    badge: 'Most Popular',
    features: [
      '200 session transcriptions / month',
      'Custom transcription templates',
      'Export reports (CSV & PDF)',
      'Full integrity analytics & telemetry',
  ...
  enterprise: {
    ...
    interviews: '300 transcribed sessions',
    highlight: false,
    features: [
      '300 session transcriptions / month',
