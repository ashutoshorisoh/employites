        ...
        <div className="min-h-[calc(100vh-73px)] flex flex-col items-center justify-center py-12 md:py-16">
          ...
          {showCandidateAccess && (
            <section className="w-full max-w-md mx-auto">
              ...
              <div className="glass-panel rounded-2xl p-8 relative overflow-hidden flex flex-col justify-between shadow-lg">
                ...
                <form onSubmit={handleCandidateSubmit} className="space-y-3 mt-8">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-zinc-950/80 border border-zinc-850 focus:border-accentPurple/50 rounded-xl text-zinc-100 placeholder-zinc-200 focus:outline-none transition-all text-xs font-bold tracking-[0.2em] text-center"
                  />
                  {candidateError && (
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 bg-gradient-to-r from-accentPurple to-accentCyan text-white text-xs font-bold uppercase tracking-wider rounded-xl transition-all shadow-md hover:shadow-lg"
                  >
        ...
        <section id="how-it-works" className="scroll-mt-20 border-t border-zinc-900/50 py-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
                ...
                {pipelineSteps.map((step, idx) => (
                  <button
                    ...
                    className={`w-full text-left flex gap-4 p-4 rounded-lg border transition-all ${
                      activeTab === idx
                        ? 'glass-panel border-accentPurple/40 bg-accentPurple/5 shadow-md'
                        : 'border-transparent bg-transparent hover:bg-accentPurple/5 hover:border-accentPurple/10'
                    }`}
                  >
                    <span className={`text-xs font-bold ${activeTab === idx ? 'text-accentPurple' : 'text-zinc-400'}`}>
                      0{idx + 1}/
                    </span>
                    <div>
                      <h4 className={`font-extrabold text-xs uppercase tracking-wider mb-1 ${activeTab === idx ? 'text-zinc-100' : 'text-zinc-400'}`}>
                        {step.title}
                      </h4>
            ...
            <div className="lg:col-span-7 flex flex-col">
              <div className="p-1 rounded-xl bg-gradient-to-br from-accentPurple/5 to-accentCyan/5 flex-1 flex flex-col">
                <div className="relative rounded-lg glass-panel flex-1 shadow-lg p-6 flex flex-col justify-between min-h-[360px] overflow-hidden">
                  <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-accentPurple via-accentCyan to-accentPink"></div>
                  {/* Top Bar / Header of Mockup */}
                  <div className="flex items-center justify-between border-b border-zinc-900/10 pb-4 mb-4">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest ml-2 font-mono">
                        Pipeline Console
                      </span>
                    </div>
                  ...
                  <div className="flex-1 flex flex-col justify-center">
                    {activeTab === 0 && (
                      <div className="space-y-4 animate-fadeIn">
                        <div className="p-4 rounded border border-zinc-900/15 bg-zinc-900/5 space-y-3">
                          <label className="block text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Configure Parameters</label>
                          <div className="grid grid-cols-2 gap-3">
                            <div className="p-2 rounded bg-zinc-950/80 border border-zinc-900/20 text-[10px] text-zinc-300 font-mono">
                          ...
                          <div className="p-2.5 rounded bg-zinc-950/80 border border-zinc-900/20 text-[10px] text-zinc-300 font-mono">
                        ...
                        <div className="flex items-center justify-between p-3 rounded bg-accentPurple/5 border border-accentPurple/20">
                          <span className="text-[10px] font-mono text-zinc-300 font-bold">https://employites.com/inv/8F2D9A</span>
                    ...
                    {activeTab === 1 && (
                      <div className="space-y-4 text-center py-6 animate-fadeIn">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-rose-500/10 border border-rose-500/20 rounded-full text-[10px] font-bold text-rose-600 uppercase tracking-widest mx-auto animate-pulse">
                          <span className="w-1.5 h-1.5 rounded-full bg-rose-500"></span> Stream Recording Live
                        </div>
                    ...
                    {activeTab === 2 && (
                      <div className="space-y-3 animate-fadeIn text-left">
                        <div className="flex gap-2">
                          <span className="text-[9px] font-bold text-emerald-600 bg-emerald-50/80 border border-emerald-500/20 px-2 py-0.5 rounded">
                            Architecture - Strong
                          </span>
                          <span className="text-[9px] font-bold text-accentPurple bg-accentPurple/5 border border-accentPurple/20 px-2 py-0.5 rounded">
                            React Hooks - Experienced
                          </span>
                        </div>
                        <div className="p-3.5 rounded border border-zinc-900/15 bg-zinc-900/5 font-mono text-[10px] text-zinc-400 max-h-[160px] overflow-y-auto space-y-2 leading-relaxed">
                          <p><span className="text-zinc-100 font-bold">00:02</span> - Candidate outlines their experience designing scalable components.</p>
                          <p><span className="text-zinc-100 font-bold">00:45</span> - Explains state virtualization and lazy rendering of large list elements.</p>
                          <p><span className="text-zinc-100 font-bold">01:30</span> - Demonstrates clear understanding of performance profiling tools.</p>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="border-t border-zinc-900/10 pt-3 mt-4 flex items-center justify-between text-[9px] text-zinc-400 font-mono">
